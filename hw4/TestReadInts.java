...
public class TestReadInts {
    ...
    public void testReadInts() {
        ...
        /* The ArrayList should throw this error because it will try to add non-integer to ArrayList<Integer> */
    }


    /** Add test for read ints **/
    @Test
    public void testReadIntsList() {
        List<Integer> actual = ReadInts.readInts("1    2 3    4 5 32");
        List<Integer> expected = Utils.createList(1, 2, 3, 4, 5, 32);
        assertEquals(expected, actual);
    }
